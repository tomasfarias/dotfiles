...
#+BEGIN_SRC emacs-lisp :results output silent
  (defun tomas/setup-font-faces ()
    ...
    (set-face-attribute 'default nil :font (font-spec :family "Maple Mono NF" :size 17 :weight 'regular :width 'normal :spacing 'm))
    (set-face-attribute 'fixed-pitch nil :font (font-spec :family "Maple Mono NF" :size 17 :weight 'regular :width 'normal :spacing 'm))
    (set-face-attribute 'variable-pitch nil :font (font-spec :family "Atkinson Hyperlegible Next" :size 20 :weight 'regular :spacing 'p))

    ;; Modeline
    (set-face-attribute 'mode-line nil :font (font-spec :family "Maple Mono NF" :weight 'regular :size 18 :height 1 :width 'normal :spacing 'm))
    (set-face-attribute 'mode-line-active nil :font (font-spec :family "Maple Mono NF" :weight 'regular :size 18 :height 1 :width 'normal :spacing 'm))
    (set-face-attribute 'mode-line-inactive nil :font (font-spec :family "Maple Mono NF" :weight 'regular :size 18 :height 1 :width 'normal :spacing 'm))

    ;; Org
    (set-face-attribute 'org-agenda-structure nil :font (font-spec :family "Maple Mono NF" :size 24 :weight 'regular :spacing 'p))
    )
