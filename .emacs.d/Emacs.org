...
#+BEGIN_SRC emacs-lisp
  (use-package eaf
    :straight (eaf
               ...
               :includes (eaf-pdf-viewer eaf-browser eaf-terminal eaf-all-the-icons)
               :files ("*.el" "*.py" "core" "app" "*.json")
               :pre-build (("python" "install-eaf.py" "--install" "pdf-viewer" "browser" "terminal" "--ignore-sys-deps"))))
  ...
  (use-package eaf-browser
    ...
    (setq eaf-python-command (expand-file-name "~/.pyenv/versions/3.10eaf/bin/python"))
    (add-to-list 'eaf-wm-focus-fix-wms 'Sway)
